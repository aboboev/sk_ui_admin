...
@Component({
    templateUrl: './pendingeuro.component.html',
    styleUrls: ['./pendingeuro.component.scss']
})
export class DepositPendingEUROComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    loadPending() {
        this.adminApi.getFinanceDepositPending('EURO', {}).subscribe(res => {
            this.loading = false;
            if (res.success) {
    ...
    withdraw(id) {
        ...
        swal({
            ...
            _parent.adminApi.depositFinancePending('EURO', {
                id: id,
            }).subscribe(res => {
    ...
    reject(id) {
        ...
        swal({
            ...
            _parent.settings.loading = true;
            _parent.adminApi.rejectFinancePending('EURO', {
                id: id,
            }).subscribe(res => {
                _parent.settings.loading = false;
