...
@Component({
    templateUrl: './pendingusd.component.html',
    styleUrls: ['./pendingusd.component.scss']
})
export class DepositPendingUSDComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    loadPending() {
        this.adminApi.getFinanceDepositPending('USD', {}).subscribe(res => {
            this.loading = false;
            if (res.success) {
    ...
    withdraw(id) {
        ...
        swal({
            ...
            _parent.adminApi.depositFinancePending('USD', {
                id: id,
            }).subscribe(res => {
    ...
    reject(id) {
        ...
        swal({
            ...
            _parent.settings.loading = true;
            _parent.adminApi.rejectFinancePending('USD', {
                id: id,
            }).subscribe(res => {
                _parent.settings.loading = false;
