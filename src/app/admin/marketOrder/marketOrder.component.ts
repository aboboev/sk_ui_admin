...
export class MarketOrderComponent implements OnInit, AfterViewInit, OnDestroy {
	all_pairs: any = {};
	pairs: any = [];
	...
	loadMarketOrders() {
		...
		this.adminApi.getMarketOpenOrders(this.selCoin, this.selMarketCoin, {
	...
	onDelete(id) {
		...
		this.adminApi.deleteMarketOrder(this.selCoin, {
			id: id
		}).subscribe( res => {
